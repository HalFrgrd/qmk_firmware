 ...
 *
 */
//Just some pins that I'm not using for the lcd
...
// LCD Configuration
#define ILI9341_SPI_DIVISOR 2
#define ILI9341_PIXDATA_BUFSIZE 240
#define LCD_RST_PIN B4
#define LCD_CS_PIN E6
#define LCD_DC_PIN B5
