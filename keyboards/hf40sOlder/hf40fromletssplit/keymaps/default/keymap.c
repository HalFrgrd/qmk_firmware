...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+---------------------------+------+------+------+------+------|
   * | ctrl |  gui | fn1  |  alt |  ctrl| spc  |lshift| enter|bckspc| NAV  |  down|  up  | left | right|
   * `-------------------------------------------------------------------------------------------------'
  */
  ...
  LT(2,KC_CAPS)  , KC_A   , KC_S   , SPECD  , SPECF   , KC_G        ,                       KC_H    , KC_J    , SPECK   , KC_L    , KC_SCLN, KC_ENT , \
    ...
    KC_LCTL      , KC_LGUI, XXXXXXX, KC_LALT, KC_LCTL , LT(1,KC_SPC), KC_LSPO,LT(1,KC_ENT), KC_BSPC , TT(NAVI), KC_DOWN   , KC_UP , KC_LEFT, KC_RIGHT \
  ),
  ...
  */
  ...
  [CAPL] = KEYMAP(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, XXXXXXX, XXXXXXX ,                  XXXXXXX, KC_RCBR, KC_PGDN   , KC_PGUP , KC_HOME, KC_END , \
  ...
  */
  ...
  [ALTB] = KEYMAP(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, M(1)   , XXXXXXX ,                  XXXXXXX, XXXXXXX, XXXXXXX   , XXXXXXX , XXXXXXX, XXXXXXX , \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX ,                  XXXXXXX, XXXXXXX, XXXXXXX   , XXXXXXX , XXXXXXX, XXXXXXX , \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX ,XXXXXXX ,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX   , XXXXXXX , XXXXXXX, XXXXXXX \
    ),
  ...
  */
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      | mleft|mright|  mup | mdwn |      |             |      | down |  up  |left  | right|      | https://stackoverflow.com/questions/6698521/vim-users-where-do-you-rest-your-right-hand
   ...
   * `-------------------------------------------------------------------------------------------------' mlfup and mlfdwn are on ring as this is ez-p in mind.
  */

  [NAVI] = KEYMAP(
    XXXXXXX, XXXXXXX, M(MUL) , XXXXXXX, M(MUR) , XXXXXXX ,                  XXXXXXX, KC_PGUP, KC_HOME   , KC_PGDN , XXXXXXX, XXXXXXX , \
    XXXXXXX, KC_MS_L, KC_MS_R, KC_MS_U, KC_MS_D, XXXXXXX ,                  XXXXXXX, KC_DOWN, KC_UP     , KC_LEFT ,KC_RIGHT, XXXXXXX , \
